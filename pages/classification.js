        ...
        () => {
            ...
            const fetchData = async () => {
                try {
                    ...
                    setData(_data); console.log(_data.length);

                    const sortedData = _data.sort((a,b)=> b.frenq - a.frenq);
                    setSortedData(sortedData); console.log(sortedData.length);
    ...
    return (
        <div>
            <React.StrictMode>
                ...
                <p style={{textAlign: "right"}}>{filteredData.length} / {data.length} Elements</p>
                <hr />
